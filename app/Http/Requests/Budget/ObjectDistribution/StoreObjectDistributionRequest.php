        ...
        return [
            ...
            'expenditure_id' => [
                ...
                Rule::unique('object_distributions')
                    ->where(fn (Builder $query) => $query->where('allocation_id', $this->integer('allocation_id')))],
            'amount' => ['required', 'decimal:0,2', 'min:0', new NotExceedAllocationAmountOnStore($this->integer('allocation_id'))],
        ];
    }
