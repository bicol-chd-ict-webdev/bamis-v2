...
export default function AccountIndex({ accounts }: AccountProps) {
    ...
    const formDefaults = { name: '', email: '', designation: '', role: '', status: 'Active' };
...
const AccountContent = ({ accounts }: AccountProps) => {
...
const AccountTable = ({ accounts, search }: { accounts: Account[]; search: string }) => {
