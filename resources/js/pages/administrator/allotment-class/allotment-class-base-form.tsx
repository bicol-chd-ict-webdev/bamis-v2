...
const AllotmentClassBaseForm = (): JSX.Element => {
    const { formHandler } = useModalContext<AllotmentClass>();
            ...
            <FieldGroup className="px-5 pt-5">
                <Field data-invalid={!!formHandler.errors.name}>
                    ...
                    <Input
                        ...
                        onBlur={(): InertiaPrecognitiveFormProps<AllotmentClass> => formHandler.validate('name')}
                    />
            ...
            <FieldGroup className="grid grid-cols-2 px-5 pb-5">
                <Field data-invalid={!!formHandler.errors.acronym}>
                    ...
                    <Input
                        ...
                        onBlur={(): InertiaPrecognitiveFormProps<AllotmentClass> => formHandler.validate('acronym')}
                    />
                ...
                <Field data-invalid={!!formHandler.errors.code}>
                    ...
                    <Input
                        ...
                        onBlur={(): InertiaPrecognitiveFormProps<AllotmentClass> => formHandler.validate('code')}
                    />
