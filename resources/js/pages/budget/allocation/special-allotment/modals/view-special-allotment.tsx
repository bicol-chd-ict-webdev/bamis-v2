...
type ViewSpecialAllotmentProps = {
    openModal: boolean;
    closeModal: () => void;
};

const ViewSpecialAllotment = ({ openModal, closeModal }: ViewSpecialAllotmentProps) => {
            ...
            <div>
                <div className="divide-input grid divide-y">
                    ...
                    {formHandler.data.saro_number && (
                        <div className="grid grid-cols-5 py-2 text-sm">
                            <p className="text-muted-foreground col-span-2">SARO Number</p>
