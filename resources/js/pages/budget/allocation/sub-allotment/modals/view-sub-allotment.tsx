...
const ViewSubAllotment = ({ openModal, closeModal }: ModalProps): JSX.Element => {
            ...
            <div className="px-5">
                <div className="grid divide-y divide-input">
                    ...
                    {formHandler.data.saa_number && (
                        <div className="grid grid-cols-5 py-2 text-sm">
                            <p className="col-span-2 text-muted-foreground">SAA Number</p>
                            <p className="col-span-3">{formHandler.data.saa_number}</p>
                        </div>
                    )}
                    {formHandler.data.department_order && (
                        <div className="grid grid-cols-5 py-2 text-sm">
                            <p className="col-span-2 text-muted-foreground">Department Order</p>
