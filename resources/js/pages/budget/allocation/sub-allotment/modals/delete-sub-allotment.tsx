...
import { destroy } from '@/routes/budget/sub-allotments';
import type { Allocation, ModalProps } from '@/types';
import { JSX } from 'react';

const DeleteSubAllotment = ({ openModal, closeModal }: ModalProps): JSX.Element => {
    ...
    const { handleSubmit } = useFormSubmit(formHandler, {
        ...
        successMessage: {
            ...
            description: 'The sub-allotment advise allocation has been permanently removed from the system.',
        },
