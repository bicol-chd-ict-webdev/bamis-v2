...
import { ObjectDistributionFormData } from '@/types/form-data';
...
const ObjectDistributionContent = ({ objectDistributions }: ObjectDistributionIndexProps) => {
    ...
    return (
        <div className="flex h-full flex-1 flex-col gap-4 rounded-xl p-4">
            ...
            <ObjectDistributuonTable objectDistributions={objectDistributions} search={search} />
...
const ObjectDistributuonTable = ({ objectDistributions, search }: { objectDistributions: ObjectDistribution[]; search: string }) => {
