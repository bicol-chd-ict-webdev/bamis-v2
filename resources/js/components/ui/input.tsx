  ...
  return (
    <input
      ...
      className={cn(
        ...
        "hover:shadow-xs",
        "focus-visible:border-primary focus-visible:ring-primary/10 focus-visible:ring-[3px] focus-visible:bg-primary/10",
        "aria-invalid:ring-destructive/10 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive aria-invalid:bg-destructive/10",
        className
      )}
      {...props}
    />
