        ...
        <>
            ...
            <ul className="mt-1 inline-flex list-inside list-disc flex-col space-y-0.5">
                {taggedObligations.map((norsa) => (
                    <li key={norsa.id}>
                        <span className="inline-flex items-center gap-1 rounded bg-muted px-2 py-0.5">{norsa.oras_number_reference}</span>
                    </li>
                ))}

                {relatedObligation && (
                    <li>
                        <span className="inline-flex items-center gap-1 rounded bg-muted px-2 py-0.5">{relatedObligation.oras_number_reference}</span>
                    </li>
                )}
            </ul>
        </>
