...
/**
* @see \App\Http\Controllers\Settings\PasswordController::editSettings
 * @see app/Http/Controllers/Settings/PasswordController.php:20
 * @route '/settings/password'
 */
export const editSettings = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: editSettings.url(options),
    method: 'get',
})
 ...
 * @route '/settings/password'
 */
editSettings.url = (options?: RouteQueryOptions) => {
    return editSettings.definition.url + queryParams(options)
}
 ...
 * @route '/settings/password'
 */
editSettings.get = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: editSettings.url(options),
    method: 'get',
})
/**
 ...
 * @route '/settings/password'
 */
editSettings.head = (options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: editSettings.url(options),
    method: 'head',
})
 ...
 * @route '/settings/password'
 */
    const editSettingsForm = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
        action: editSettings.url(options),
        method: 'get',
    })
 ...
 * @route '/settings/password'
 */
        editSettingsForm.get = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
            action: editSettings.url(options),
            method: 'get',
        })
            /**
 ...
 * @route '/settings/password'
 */
        editSettingsForm.head = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
            action: editSettings.url({
                        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
                            _method: 'HEAD',
                            ...(options?.query ?? options?.mergeQuery ?? {}),
                        }
...
/**
* @see \App\Http\Controllers\Settings\PasswordController::updateSettings
